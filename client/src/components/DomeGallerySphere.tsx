...
const DEFAULT_IMAGES = [
  { src: '/assets/Alluarjun.jpg', alt: 'Allu Arjun' },
  { src: '/assets/MaheshBabu.jpg', alt: 'Mahesh Babu' },
  { src: '/assets/NTR.jpg', alt: 'NTR' },
  { src: '/assets/RamCharan.jpg', alt: 'Ram Charan' },
  { src: '/assets/prabhas.jpg', alt: 'Prabhas' },
  { src: '/assets/Nani.jpg', alt: 'Nani' },
  { src: '/assets/pawankalyan.jpg', alt: 'Pawan Kalyan' },
  { src: '/assets/Raviteja.jpg', alt: 'Ravi Teja' }
];
